/*
 * Referensi minimal Layer 1: kirim satu record telemetri (payload dummy) ke
 * Laravel  POST /api/kirim_sensor  -- untuk uji koneksi / template integrasi.
 * Firmware lapangan lengkap (17 kanal sensor + aktuasi UV/ultrasonik/irigasi
 * via MQTT + REST sesuai manuscript sec. 3.6 / Algorithm 1) ada di
 * Arduino/padi_sawah/padi_sawah.ino.
 */
#include <WiFi.h>
