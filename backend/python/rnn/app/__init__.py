...
HISTORY_URL = "http://localhost/api/sensor?iot_id=jTZids5M"  # Diganti dari file menjadi URL
...
def create_app():
    ...
    # Initialize services with URL source for data
    data_service = DataService(HISTORY_URL)
